...
public class LeasesDaoImpl implements LeasesDao {
	...
	public List<Leases> findActiveLeases() {
		String sql = "SELECT l.leaseID, l.vehicleID, l.customerID, l.startDate, l.endDate, l.leaseType "
				+ "FROM Leases l JOIN Payments p USING (leaseID) WHERE endDate >= CURDATE() "
