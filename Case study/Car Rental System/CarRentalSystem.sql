...
-- consider adding address here in contactinfo
CREATE TABLE IF NOT EXISTS ContactInfo (
    ...
    INDEX idx_phone (phoneNumber) -- Improves search speed for phone lookups when customers log in
);
alter table contactinfo add column address varchar(25);
...
CREATE TABLE IF NOT EXISTS Payments (
    ...
    paymentStatus ENUM('PENDING', 'PAID', 'FAILED') DEFAULT 'PAID',
