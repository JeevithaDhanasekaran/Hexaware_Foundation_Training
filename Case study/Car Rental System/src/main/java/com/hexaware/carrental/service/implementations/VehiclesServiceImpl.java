...
import com.hexaware.carrental.dao.implementations.CarStatusDaoImpl;
import com.hexaware.carrental.dao.implementations.HostVehicleDaoImpl;
import com.hexaware.carrental.dao.implementations.VehicleCityDaoImpl;
...
//		carStatus.setStatus(newStatus);
		...
		return carStatusDao.updateCarStatus(vehicleId,newStatus);
	}
	...
	public int getVehicleIdByLeaseId(int leaseId) throws DatabaseConnectionException {
	    return vehiclesDao.getVehicleIdByLeaseId(leaseId);
	}
	
	@Override
	public List<Vehicles> getAvailableVehicles() throws DatabaseConnectionException{
	return vehiclesDao.getAvailableVehicles();
	}
