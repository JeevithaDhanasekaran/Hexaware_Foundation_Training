...
public class Auth {
	...
	if(userName == null || !userName.matches("^[a-zA-Z0-9.-+%@]{7,12}")) {
		throw new InvalidInputException("Username should be 7-14 characters & allowed: a-z, A-Z, 0-9, . _ + % @ - ");
	}
	else
		this.userName=userName;
}
	...
	public void setPassword(String password) throws InvalidInputException {
		if(password==null || password.trim().isEmpty()  || ! password.matches("^[a-zA-Z0-9.-+%@]{6,12}")) {
